export const en = {
    ...
    wbTypeAuto:'Type (auto)',
    wbType:'Type (Workbench)',
    automatic:'Automatic',
    ...
    editTargetGroups:'Edit target groups',
    ...
    refreshTroops:'Refresh troops',
    refreshTroopsUnsupported:'This plan was created before this feature - create a new plan to use it.',
    refreshTroopsSuccess:'Troops refreshed!',
